...
func SaveMeta(filehash string, filename string,
	filesize int64, fileaddr string) bool {
	dbOpt := NewDB()
	// Prepare预先创建一个statement为了之后的查询与执行
	stmt, err := dbOpt.Prepare("insert ignore into tbl_file (`file_sha1`,`file_name`,`file_size`," +
